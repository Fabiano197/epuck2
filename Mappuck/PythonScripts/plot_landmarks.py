...
def readMessageSerial(port):
    ...
    plt.plot(xCoor[0], yCoor[0], 'ro')
    plt.plot(xCoor[1], yCoor[1], 'bo')
    plt.scatter(xCoor[2], yCoor[2], marker='.', c=zCoor[2], cmap='nipy_spectral')
    plt.colorbar()
    plt.scatter(current_pos.x, current_pos.y, marker='*', linewidths=4, c='black', s=200, zorder=3)
